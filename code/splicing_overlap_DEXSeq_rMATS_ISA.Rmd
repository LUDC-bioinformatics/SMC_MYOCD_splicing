...
legend('topleft', legend = paste('rho = ',
       round(cor(DEXSeq_rMATS_SE_unique$DEXSeq_log2fold_treatment_control,
                 DEXSeq_rMATS_SE_unique$rMATS_SE_IncLevelDifference, method = "spearman"), 2), sep = ""),
...
abline(lm(rMATS_RI_IncLevelDifference~DEXSeq_log2fold_treatment_control, data=DEXSeq_rMATS_RI))
legend('topleft', legend = paste('rho = ',
       round(cor(DEXSeq_rMATS_RI$DEXSeq_log2fold_treatment_control,
                 DEXSeq_rMATS_RI$rMATS_RI_IncLevelDifference, method = "spearman"), 2), sep = ""),
       bty='n', bg='white', cex= 1)
cor.test(DEXSeq_rMATS_RI$DEXSeq_log2fold_treatment_control,
                 DEXSeq_rMATS_RI$rMATS_RI_IncLevelDifference, method = "spearman")
```

...
```{r}
interesting_genes_rows <- grep(paste(interesting_genes,collapse="|"), overlap_annot$symbol)
dxr_interesting_genes <- overlap_annot[interesting_genes_rows,]
knitr::kable(head(dxr_interesting_genes[,c(1:4)]))
```
